...
echo GridView::widget([
    ...
    'columns' => [
        ...
        'created:datetime',
        [
            'header' => Yii::t('app.f12.notifications', 'Status'),
            'content' => function (NotificationInterface $model) {
                return Yii::t('app.f12.notifications', $model->isUnreaded() ? 'Unreaded' : 'Readed');
            }
        ],
        [
            'header' => Yii::t('app.f12.notifications', 'Owner'),
            'content' => function (NotificationInterface $model) {
                if (!$model->getOwner())
                    return Yii::t('app.f12.notifications', 'Owner is not found');
